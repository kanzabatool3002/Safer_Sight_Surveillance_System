			...
			<div className='p-8'>
				...
				<form onSubmit={handleLogin}>
					...
					<motion.button
						...
						whileTap={{ scale: 0.98 }}
						className='w-full py-3 px-4 bg-gradient-to-r from-blue-700 to-blue-700 text-white font-bold rounded-lg shadow-lg hover:from-white-600 hover:to-blue-700 focus:outline-none focus:ring-2 focus:ring-white-500 focus:ring-offset-2 focus:ring-offset-gray-900 transition duration-200'
						type='submit'
						disabled={isLoading}
					>
